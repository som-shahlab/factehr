...
@Language.component(name="ct_sentence_splitter")
def ct_sentence_splitter(doc):
...
@Language.component(name="fast_ct_sentence_splitter")
def ct_fast_sentence_splitter(doc):
