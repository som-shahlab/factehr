...
input_notes_path = "/Users/akshayswaminathan/just-the-facts/data/datasets/prompted_sampled/fact_decomposition_20241001.jsonl"
facts_generated_path = "/Users/akshayswaminathan/just-the-facts/data/datasets/completions/test/merged_shc-gpt-4o_max4000.jsonl"
facts_split_path = "/Users/akshayswaminathan/just-the-facts/data/datasets/completions/test/entailment_input_shc-gpt-4o.jsonl"
entailment_predictions_path = "/Users/akshayswaminathan/just-the-facts/data/datasets/completions/test/entailment_shc-gpt-4o_predictions.jsonl"
...
entailment_predictions['precision_recall'] = entailment_predictions['metadata'].apply(lambda x: x['metadata']["custom_id"].split("|")[-1] )

entailment_predictions[['precision_recall', 'entailment_pred']]
